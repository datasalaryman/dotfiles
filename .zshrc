...
export PATH=$HOME/bin:$HOME/.local/bin:/opt/homebrew/bin:$HOME/.pyenv/bin:$HOME/.pyenv/shims:/opt/homebrew/opt/node@18/bin:$HOME/.gcloud/bin:$PATH
...
ssh-add ~/.ssh/enzo_key_pair_aws.pem &> /dev/null
