...
export PATH=$HOME/bin:$HOME/.local/bin:/opt/homebrew/bin:/opt/homebrew/opt/node@18/bin:$HOME/.gcloud/bin:$HOME/.avm/bin:$HOME/.local/share/nvim/mason/bin/:$PATH
...
export PATH="$PATH:/Users/joseendrinal/.lmstudio/bin"
